...
_Generated: 2026-05-09 13:59:09 UTC_
...
| 13:58:42 | SYSTEM | 📦 Master Report Bundle downloaded → eow_bundle_1778335117.zip (823 trades, 906 KB) |
| 13:58:43 | SYSTEM | 🔬 Live Process Snapshot downloaded → eow_live_process_20260509_135843.zip (170 KB / logs=2000 rl_contexts=9 tr |
| 13:58:55 | TRADE | [TM] NEARUSDT BE: SL→1.5678 (R=1.06≥1.0 mode=TREND_FOLLOW → SL→BE) |
| 13:59:02 | SIGNAL | 📈 STREAK TONUSDT: COLD len=3 score_adj=+0.05 → eff_min=0.480 |
| 13:59:02 | FILTER | ⚡ PAPER_SPEED TONUSDT: RSI filter blocked (rsi=31.0 above_sma=False regime=TRENDING) |
| 13:59:02 | SIGNAL | 📈 STREAK ICPUSDT: COLD len=3 score_adj=+0.05 → eff_min=0.480 |
| 13:59:02 | FILTER | ⚡ PAPER_SPEED ICPUSDT: RSI filter blocked (rsi=70.0 above_sma=True regime=MEAN_REVERTING) |
| 13:59:02 | SIGNAL | 📈 STREAK ONDOUSDT: COLD len=3 score_adj=+0.05 → eff_min=0.480 |
| 13:59:02 | FILTER | ⚡ PAPER_SPEED ONDOUSDT: RSI filter blocked (rsi=40.7 above_sma=False regime=MEAN_REVERTING) |
| 13:59:02 | SIGNAL | 📈 STREAK SAHARAUSDT: COLD len=3 score_adj=+0.05 → eff_min=0.480 |
| 13:59:02 | FILTER | ⚡ PAPER_SPEED SAHARAUSDT: RSI filter blocked (rsi=27.0 above_sma=False regime=TRENDING) |
| 13:59:02 | SIGNAL | 📈 STREAK ETHUSDT: COLD len=3 score_adj=+0.05 → eff_min=0.480 |
| 13:59:02 | FILTER | ⚡ PAPER_SPEED ETHUSDT: RSI filter blocked (rsi=63.8 above_sma=True regime=MEAN_REVERTING) |
| 13:59:02 | SIGNAL | 📈 STREAK STRKUSDT: COLD len=3 score_adj=+0.05 → eff_min=0.480 |
| 13:59:03 | FILTER | ⚡ PAPER_SPEED STRKUSDT: RSI filter blocked (rsi=57.1 above_sma=True regime=MEAN_REVERTING) |
| 13:59:03 | SIGNAL | 📈 STREAK UNIUSDT: COLD len=3 score_adj=+0.05 → eff_min=0.480 |
| 13:59:03 | FILTER | ⚡ PAPER_SPEED UNIUSDT: RSI filter blocked (rsi=57.1 above_sma=False regime=MEAN_REVERTING) |
| 13:59:03 | SIGNAL | 📈 STREAK GALAUSDT: COLD len=3 score_adj=+0.05 → eff_min=0.480 |
| 13:59:03 | FILTER | ⚡ PAPER_SPEED GALAUSDT: RSI filter blocked (rsi=50.0 above_sma=True regime=MEAN_REVERTING) |
| 13:59:04 | SIGNAL | 📈 STREAK LTCUSDT: COLD len=3 score_adj=+0.05 → eff_min=0.480 |
| 13:59:04 | FILTER | ⚡ PAPER_SPEED bypass LTCUSDT: SLEEP_MODE(vol=30=10%_of_avg=315,min=10%[base=45%×0.20]) |
| 13:59:04 | SIGNAL | ⚡ PAPER_SPEED fallback LTCUSDT: SHORT entry=58.0600 rsi=60.0 |
| 13:59:04 | SIGNAL | 📈 STREAK FILUSDT: COLD len=3 score_adj=+0.05 → eff_min=0.480 |
| 13:59:04 | FILTER | ⚡ PAPER_SPEED FILUSDT: RSI filter blocked (rsi=45.5 above_sma=False regime=MEAN_REVERTING) |
| 13:59:05 | SIGNAL | 📈 STREAK OPUSDT: COLD len=3 score_adj=+0.05 → eff_min=0.480 |
| 13:59:05 | FILTER | ⚡ PAPER_SPEED bypass OPUSDT: SLEEP_MODE(vol=6233=9%_of_avg=69752,min=10%[base=45%×0.20]) |
| 13:59:05 | SIGNAL | ⚡ PAPER_SPEED fallback OPUSDT: SHORT entry=0.1647 rsi=59.1 |
...
| Halted | False |
| Graceful stop | False |
| Open positions | [{'position_id': 'b689c206', 'symbol': 'NEARUSDT', 'side': 'SHORT', 'entry_price': 1.57, 'qty': 96.100455, 'stop_loss': 1.5678020000000001, 'take_profit': 1.55587, 'entry_ts': 1778334854135, 'strategy_id': 'MeanReversion_PAPER_SPEED', 'trailing_sl': True, 'peak_price': 1.566, 'initial_risk': 3.7719, 'initial_stop_loss': 1.573768, 'regime': 'MEAN_REVERTING', 'order_type': 'MARKET', 'breakeven_armed': True, 'peak_r': 1.0615711252653954, 'ticks_since_peak': 1}, {'position_id': '7eb02416', 'symbol': 'NOTUSDT', 'side': 'SHORT', 'entry_price': 0.000629, 'qty': 239869.180805, 'stop_loss': 0.0006281194, 'take_profit': 0.000620650025, 'entry_ts': 1778334959636, 'strategy_id': 'MeanReversion_PAPER_SPEED', 'trailing_sl': True, 'peak_price': 0.000626, 'initial_risk': 3.7719, 'initial_stop_loss': 0.00063122666, 'regime': 'MEAN_REVERTING', 'order_type': 'MARKET', 'breakeven_armed': True, 'peak_r': 1.3473094230820928, 'ticks_since_peak': 331}, {'position_id': '2eb6506e', 'symbol': 'BTCUSDT', 'side': 'SHORT', 'entry_price': 80377.9, 'qty': 0.001877, 'stop_loss': 80570.80696, 'take_profit': 79654.49889999999, 'entry_ts': 1778335021268, 'strategy_id': 'MeanReversion_PAPER_SPEED', 'trailing_sl': True, 'peak_price': 80377.89, 'initial_risk': 3.7719, 'initial_stop_loss': 80570.80696, 'regime': 'MEAN_REVERTING', 'order_type': 'MARKET', 'breakeven_armed': False, 'peak_r': 5.183846137413041e-05, 'ticks_since_peak': 327}] |
| Daily PnL | — |
...
| edge_kill_at | 0.0 |
| boost_mult | 1.25 |
| strategies | {'MEAN_REVERTING@MeanReversion_PAPER_SPEED': {'n_trades': 25, 'edge': -0.2028, 'win_rate': 0.16, 'size_mult': 1.0, 'disabled': True, 'kill_age_s': 1618.8}} |
