...
_Generated: 2026-05-09 11:10:37 UTC_
...
| Time | Level | Message |
|---|---|---|
| 11:09:59 | SIGNAL | ⚡ DTP BTCUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 11:09:59 | SIGNAL | 📈 STREAK BTCUSDT: COLD len=5 score_adj=+0.05 → eff_min=0.400 |
| 11:09:59 | FILTER | ⚡ PAPER_SPEED BTCUSDT: RSI filter blocked (rsi=50.6 above_sma=True regime=MEAN_REVERTING) |
| 11:10:00 | SIGNAL | ⚡ DTP ETHUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 11:10:00 | SIGNAL | 📈 STREAK ETHUSDT: COLD len=5 score_adj=+0.05 → eff_min=0.400 |
| 11:10:00 | FILTER | ⚡ PAPER_SPEED ETHUSDT: RSI filter blocked (rsi=61.6 above_sma=True regime=MEAN_REVERTING) |
| 11:10:00 | SIGNAL | ⚡ DTP GALAUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 11:10:00 | SIGNAL | 📈 STREAK GALAUSDT: COLD len=5 score_adj=+0.05 → eff_min=0.400 |
| 11:10:00 | FILTER | ⚡ PAPER_SPEED GALAUSDT: RSI filter blocked (rsi=71.4 above_sma=True regime=TRENDING) |
| 11:10:00 | SIGNAL | ⚡ DTP LTCUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 11:10:00 | SIGNAL | 📈 STREAK LTCUSDT: COLD len=5 score_adj=+0.05 → eff_min=0.400 |
| 11:10:00 | FILTER | ⚡ PAPER_SPEED LTCUSDT: RSI filter blocked (rsi=61.5 above_sma=True regime=TRENDING) |
| 11:10:01 | SIGNAL | ⚡ DTP STRKUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 11:10:01 | SIGNAL | 📈 STREAK STRKUSDT: COLD len=5 score_adj=+0.05 → eff_min=0.400 |
| 11:10:01 | FILTER | ⚡ PAPER_SPEED STRKUSDT: RSI filter blocked (rsi=46.2 above_sma=False regime=TRENDING) |
| 11:10:05 | SIGNAL | ⚡ DTP FILUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 11:10:05 | SIGNAL | 📈 STREAK FILUSDT: COLD len=5 score_adj=+0.05 → eff_min=0.400 |
| 11:10:05 | FILTER | ⚡ PAPER_SPEED FILUSDT: RSI filter blocked (rsi=62.5 above_sma=True regime=MEAN_REVERTING) |
| 11:10:09 | SIGNAL | ⚡ DTP NEARUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 11:10:09 | SIGNAL | 📈 STREAK NEARUSDT: COLD len=5 score_adj=+0.05 → eff_min=0.400 |
| 11:10:09 | FILTER | ⚡ PAPER_SPEED NEARUSDT: RSI filter blocked (rsi=68.8 above_sma=True regime=TRENDING) |
| 11:10:11 | SIGNAL | ⚡ DTP ICPUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 11:10:11 | SIGNAL | 📈 STREAK ICPUSDT: COLD len=5 score_adj=+0.05 → eff_min=0.400 |
| 11:10:11 | FILTER | ⚡ PAPER_SPEED ICPUSDT: RSI filter blocked (rsi=47.6 above_sma=True regime=MEAN_REVERTING) |
| 11:10:36 | SIGNAL | ⚡ DTP OPUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 11:10:36 | SIGNAL | 📈 STREAK OPUSDT: COLD len=5 score_adj=+0.05 → eff_min=0.400 |
| 11:10:36 | SIGNAL | ⚡ PAPER_SPEED fallback OPUSDT: SHORT entry=0.1642 rsi=64.5 |
| 11:10:36 | SIGNAL | ⚡ DTP ARBUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 11:10:36 | SIGNAL | 📈 STREAK ARBUSDT: COLD len=5 score_adj=+0.05 → eff_min=0.400 |
| 11:10:36 | FILTER | ⚡ PAPER_SPEED ARBUSDT: RSI filter blocked (rsi=60.0 above_sma=True regime=MEAN_REVERTING) |
...
| edge_kill_at | 0.0 |
| boost_mult | 1.25 |
| strategies | {'MEAN_REVERTING@MeanReversion_PAPER_SPEED': {'n_trades': 21, 'edge': -0.2472, 'win_rate': 0.095, 'size_mult': 1.0, 'disabled': True, 'kill_age_s': 5116.2}} |
...
-   - TRADE DRY-SPELL — 74 min since last trade: Trade Activator should be auto-relaxing thresholds after 60 min.
