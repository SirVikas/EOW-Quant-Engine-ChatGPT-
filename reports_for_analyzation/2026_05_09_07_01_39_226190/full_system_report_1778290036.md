...
_Generated: 2026-05-09 01:27:16 UTC_
...
| Time | Level | Message |
|---|---|---|
| 01:27:09 | FILTER | ⚡ PAPER_SPEED NOTUSDT: RSI filter blocked (rsi=20.0 above_sma=False regime=TRENDING) |
| 01:27:09 | SIGNAL | ⚡ DTP JTOUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 01:27:09 | SIGNAL | 📈 STREAK JTOUSDT: COLD len=7 score_adj=+0.05 → eff_min=0.400 |
| 01:27:09 | SIGNAL | ⚡ PAPER_SPEED fallback JTOUSDT: LONG entry=0.5681 rsi=59.9 |
| 01:27:10 | SIGNAL | ⚡ DTP ICPUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 01:27:10 | SIGNAL | 📈 STREAK ICPUSDT: COLD len=7 score_adj=+0.05 → eff_min=0.400 |
| 01:27:10 | FILTER | ⚡ PAPER_SPEED ICPUSDT: RSI filter blocked (rsi=76.4 above_sma=True regime=TRENDING) |
| 01:27:10 | SIGNAL | ⚡ DTP TONUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 01:27:10 | SIGNAL | 📈 STREAK TONUSDT: COLD len=7 score_adj=+0.05 → eff_min=0.400 |
| 01:27:10 | SIGNAL | ⚡ PAPER_SPEED fallback TONUSDT: SHORT entry=2.5520 rsi=46.3 |
| 01:27:11 | SIGNAL | ⚡ DTP ONDOUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 01:27:11 | SIGNAL | 📈 STREAK ONDOUSDT: COLD len=7 score_adj=+0.05 → eff_min=0.400 |
| 01:27:11 | SIGNAL | ⚡ PAPER_SPEED fallback ONDOUSDT: SHORT entry=0.4689 rsi=50.4 |
| 01:27:11 | SIGNAL | ⚡ DTP NILUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 01:27:11 | SIGNAL | 📈 STREAK NILUSDT: COLD len=7 score_adj=+0.05 → eff_min=0.400 |
| 01:27:11 | SIGNAL | ⚡ PAPER_SPEED fallback NILUSDT: SHORT entry=0.0709 rsi=49.2 |
| 01:27:13 | SIGNAL | ⚡ DTP NEARUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 01:27:13 | SIGNAL | 📈 STREAK NEARUSDT: COLD len=7 score_adj=+0.05 → eff_min=0.400 |
| 01:27:13 | FILTER | ⚡ PAPER_SPEED NEARUSDT: RSI filter blocked (rsi=74.1 above_sma=True regime=TRENDING) |
| 01:27:13 | SIGNAL | ⚡ DTP STRKUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 01:27:13 | SIGNAL | 📈 STREAK STRKUSDT: COLD len=7 score_adj=+0.05 → eff_min=0.400 |
| 01:27:13 | SIGNAL | ⚡ ALPHA PullbackEntry STRKUSDT score=0.584 rr=5.00 |
| 01:27:13 | SIGNAL | ⚡ PAPER_SPEED fallback STRKUSDT: SHORT entry=0.0555 rsi=55.6 |
| 01:27:15 | SIGNAL | ⚡ DTP FILUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 01:27:15 | SIGNAL | 📈 STREAK FILUSDT: COLD len=7 score_adj=+0.05 → eff_min=0.400 |
| 01:27:15 | FILTER | ⚡ PAPER_SPEED FILUSDT: RSI filter blocked (rsi=70.6 above_sma=True regime=TRENDING) |
| 01:27:16 | SIGNAL | ⚡ DTP LUNCUSDT: tier=TIER_3 af=RELAX score_min=0.400 vol_mult=0.20× fee_tol=0.10 |
| 01:27:16 | SIGNAL | 📈 STREAK LUNCUSDT: COLD len=7 score_adj=+0.05 → eff_min=0.400 |
| 01:27:16 | SIGNAL | ⚡ PAPER_SPEED fallback LUNCUSDT: SHORT entry=0.0001 rsi=61.9 |
| 01:27:16 | SIGNAL | 🔔 Signal SHORT LUNCUSDT / PAPER_SPEED_FALLBACK(momentum micro-signal) |
...
| edge_kill_at | 0.0 |
| boost_mult | 1.25 |
| strategies | {'MEAN_REVERTING@MeanReversion_PAPER_SPEED': {'n_trades': 7, 'edge': -0.501, 'win_rate': 0.0, 'size_mult': 1.0, 'disabled': True, 'kill_age_s': 16686.1}} |
