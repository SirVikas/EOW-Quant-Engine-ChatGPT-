...
| 02:26:10 | SIGNAL | 💰 Orchestrator NILUSDT: score=0.246 upstream_mult=0.00× conc_mult=1.00× band=BYPASS rank=1.000 amplified=False |
...
| Halted | False |
| Graceful stop | False |
| Open positions | [{'position_id': '0f5cfb3d', 'symbol': 'NILUSDT', 'side': 'LONG', 'entry_price': 0.07086, 'qty': 2178.285592, 'stop_loss': 0.07066965067999999, 'take_profit': 0.07168587330000001, 'entry_ts': 1778293570557, 'strategy_id': 'MeanReversion_PAPER_SPEED', 'trailing_sl': True, 'peak_price': 0.071, 'initial_risk': 3.8588, 'initial_stop_loss': 0.07063976712, 'regime': 'MEAN_REVERTING', 'order_type': 'MARKET', 'breakeven_armed': False, 'peak_r': 0.6356907288320649, 'ticks_since_peak': 33}] |
| Daily PnL | — |
