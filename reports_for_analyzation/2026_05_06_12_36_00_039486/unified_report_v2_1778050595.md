...
_Generated: 2026-05-06 06:56:35 UTC_  
...
|---|---|
| System State | ACTIVE |
| Trading Activity | IDLE (202 min — activator tier=TIER_3) |
| Profitability | LOSS (PF=0.51, net=$-180.42) |
| Key Problem | System idle 202 min — no signal passing quality threshold |
...
| Metric | Value |
|---|---|
| Signals Generated (window) | 456 |
| Signals Passed → Traded | 0 |
| Signals Rejected | 0 |
| Pass Rate | 0.0% |
| Reject Rate | 0.0% |
| Rejection Rate (window %) | 0.0% |
| Mins Since Last Trade | 202.3 |
| Signals / hour | 456.0 |
| Trades / hour | 0.00 |
| Execution Gap | 456 signal(s) → 0 trades |
...
| Net PnL | $-180.42 |
| Fees Paid | $81.90 |
| Capital Deployed | 9.9% |
| Capital Idle | 90.1% |
| Daily Risk Used | $74.03 |
| Daily Risk Remaining | N/A |
| Daily Cap | 6.0% |
| Missed Opportunity | Signals available (456) but execution blocked by unknown gating |
...
| Fee Impact | 31.2% |
| Fee per Trade (avg) | $81.90 |
| Win Rate | 32.8% |
| Avg Win | +$1.09 |
| Avg Loss | $-1.04 |
| Total Trades | 0 |
| Total Net PnL | $-180.42 |

**Edge Consistency (strategy × regime):**
- - MEAN_REVERTING@MeanReversion_PAPER_SPEED: edge=-0.342 wr=20% n=10 [DISABLED]
...
**NO TRADES EXECUTED (456 signal(s) blocked)**
...
**HIGH FEE DRAG (31% of gross)**
  ...
  Impact: Fees consuming $81.90 of gross turnover
  Fix: Increase MIN_NOTIONAL_USDT; reduce trade frequency

**TRADE DRY-SPELL (202 min)**
...
- Investigate top skip reasons — idle 202 min suggests systematic quality miss
...
- Issue:  NO_EXECUTION
- Cause:  NONE dominant block (456 → 0)
- Capital Idle:  90.1% (missed opportunity)
- Fix:    Signal passes all gates AND score ≥ 0.400

```
Generated:       2026-05-06 06:56:35 UTC
Trades (total):  0  |  PF: 0.512  |  WR: 32.8%
Gate:            can_trade=True  reason=ALL_CLEAR
Tier:            TIER_3  score_min=0.4  vol_mult=0.2×
Idle:            202.3 min
Signals/hr:      456.0  Skips(window):   0
Top Errors:
  WS_001:gap=50.3s: 1×
```
...
| Metric | Value |
|---|---|
| RL Phase | CONVERGING (30% exploration — alpha contexts emerging) |
| Uptime | 230.9 min |
| Total Contexts Seen | 9 |
| Profitable Contexts | 0% |
| Allowed / Blocked | 277 / 0 |
| Allow Rate | 100% |
| Explore Trades | 82 (30%) |
| Exploit Trades | 195 (70%) |
...
| MEAN_REVERTING|LONDON|MeanReversion | ▼0.0000 | +inf | 0% | 0 | $+0.000 |

**Near-Block Contexts (RL considering suppression):**

| Context | Q-Value | UCB Score | Win Rate | Trades | Near Block? |
|---|---|---|---|---|---|
| MEAN_REVERTING|ASIA|MeanReversion | -0.2526 | +0.8723 | 20% | 10 | No |