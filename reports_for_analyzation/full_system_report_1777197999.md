...
_Generated: 2026-04-26 10:06:39 UTC_
...
The engine closed **134** trades with a net **LOSS** of **-136.89 USDT**.
...
| Metric | Value |
|---|---|
| Final Capital (USDT) | 863.11 |
| Net PnL (USDT) | -136.8917 |
| Total Trades | 134 |
| Win Rate | 49.2% |
| Profit Factor | 0.371 |
| Sharpe | -3.620 |
...
| Time | Level | Message |
|---|---|---|
| 10:04:41 | SYSTEM | 🚀 EOW Quant Engine booting… |
| 10:04:41 | SYSTEM | Mode: PAPER / Capital: 1000.0 USDT |
| 10:04:41 | SYSTEM | 📋 Function Registry loaded — 81 functions registered |
| 10:04:42 | SYSTEM | 📂 DataLake replay: 134 trades → equity=863.11 USDT |
| 10:04:42 | SYSTEM | 📂 State restored: snapshot(863.11) validated vs replay(863.11) |
| 10:04:42 | SYSTEM | ⚡ Phase 4 Profit Engine online / rr_min=1.5 score_min=0.58 max_per_trade=5% daily_cap=3% |
| 10:04:42 | SYSTEM | 🧠 Phase 5 EV Engine online / ev_window=30 ev_min_trades=10 adaptive_lr=0.05 dd_stop=15% |
| 10:04:42 | SYSTEM | 🔓 Phase 5.1 Activation Layer online / activator_tiers=T1@3min T2@7min T3@15min / explore_rate=35% smart_fee_rr |
| 10:04:42 | SYSTEM | Phase 6.6 Gate online / can_trade=True reason=BOOT_GRACE safe_mode=False |
| 10:04:42 | SYSTEM | All subsystems online. Scanning markets… |
| 10:04:42 | SYSTEM | ⚡ [FTD-031] Performance layer online / target=100.0ms cache_ttl_pattern=60.0s queue_workers=2 |
| 10:04:50 | SYSTEM | 📥 DNA imported from D:\EOW Quant Engine V17.0(ChatGPT)_INVERSE_LOGIC\eow_quant_engine_FINAL_v2.2\eow_quant_eng |
| 10:05:05 | SYSTEM | ⚡ Mode switched to PAPER |
...
|---|---|---|---|
| 1777197961.1302698 | STRAT_001 | XRPUSDT | adx=23.0 conf=0.00 |
| 1777197902.2079165 | STRAT_001 | TRUMPUSDT | adx=17.3 conf=0.00 |
| 1777197888.331237 | STRAT_001 | XRPUSDT | adx=23.6 conf=0.00 |
...
- **PRIMARY ISSUE:** SYSTEM IN LOSS — profit_factor=0.371 (negative expectancy)
-   Detail — 134 trades; win_rate=49.2%. Every trade destroys capital on average. Immediate action required.
