ENDPOINTS = [
  {"path": "/api/forensics/recovery-cycle-audit",    "interval_min": 60,  "label": "Recovery Cycle Audit"},
  ...
  {"path": "/api/observability/summary",             "interval_min": 30,  "label": "Observability"},
  {"path": "/api/auto-intelligence/state",           "interval_min": 15,  "label": "Auto Intelligence State"},
  {"path": "/api/perf-status",                       "interval_min": 30,  "label": "Performance Status"},
]
